...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ6Ym5udmdjY3ZvcGp4aWdpaXN4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI4MjA5MDQsImV4cCI6MjA2ODM5NjkwNH0.piiyaa3Sofym3dnNfsJfAgGuCb2XXsLubQvWPNPxrIk'
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6">
          ...
          <div className="space-y-2 text-sm font-mono">
            <p>Process env URL: {process.env.NEXT_PUBLIC_SUPABASE_URL || 'NOT SET'}</p>
            <p>Process env Key: {process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? 'SET' : 'NOT SET'}</p>
